...
public class LoseRndMenuViewer extends Viewer<LoseRndMenu> {
    public LoseRndMenuViewer(LoseRndMenu menu) {
        super(menu);
    }
    ...
    public void drawElements(GUI gui) {
        ...
        gui.drawText(new Position(15, 8), "game   over", "#FFFFFF");
        gui.drawCherry(new Position(20, 7));
