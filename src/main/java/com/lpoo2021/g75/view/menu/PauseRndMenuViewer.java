...
public class PauseRndMenuViewer extends Viewer<PauseRndMenu> {
    public PauseRndMenuViewer(PauseRndMenu menu) {
        super(menu);
    }
    ...
    public void drawElements(GUI gui) {
        ...
        gui.drawText(new Position(15, 8), "pause game", "#FFFFFF");
